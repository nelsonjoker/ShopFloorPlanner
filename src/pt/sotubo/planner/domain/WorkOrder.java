...
public class WorkOrder implements Serializable{
	...
	@CustomShadowVariable(variableListenerClass = OperationDateUpdatingVariableListener.class, sources = {@CustomShadowVariable.Source(variableName = "startDate",  entityClass = Operation.class)})
